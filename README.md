...
* Deploy logs & history
* Package management
   * Hard drive / fileshare zip files (version / branch / commit can be extracted from zip file)
...
* User can select version to deploy to a specific machine
...
* Execute verify step on each deploy unit / machine, what the verify step does is up to the agnet and depends on the deploy unit type.
